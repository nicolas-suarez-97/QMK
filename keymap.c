...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+------+------+------+------+------|  |------+------+------+-------+------+-------+--------|
                               KC_LGUI,LOWER, LCTL_T(KC_SPC),   RCTL_T(KC_ENT), RAISE, KC_LALT
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+-------+-------+-------+-------|                |------+------+------+------+------+------|
    KC_LSFT, KC_NO,KC_BTN2,KC_WH_D,KC_WH_U,KC_ENT,                KC_HOME,KC_PGDN,KC_PGUP,KC_END,KC_NO,KC_NO,
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_LCTL, KC_F1, KC_F2, KC_ASTR, KC_LPRN, KC_F5,                KC_MINS,KC_EQL,KC_LCBR,KC_RCBR,KC_PIPE,KC_GRV,
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_LSFT, KC_F6, KC_F7, KC_QUOT, KC_BSLS,KC_F10,                KC_UNDS,KC_PLUS,KC_LBRC,KC_RBRC,KC_BSLS,KC_RSFT,
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                KC_LGUI, LOWER,KC_SPC,   KC_ENT, RAISE,KC_RALT
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,               KC_NO,KC_4, KC_5, KC_6, KC_NO, KC_LBRC,
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
